const STORAGE_KEY = "tmod-timer-sections";
const DEFAULT_SECTIONS = [
  { name: "オープニング", duration: 5 },
  { name: "ヘルパー紹介", duration: 5 },
  { name: "準備スピーチ", duration: 25 },
  { name: "Tabletopics", duration: 20 },
  { name: "休憩", duration: 5 },
  { name: "論評", duration: 20 },
...
function startTimer() {
  ...
  let elapsedDataset = chart.data.datasets.find((d) => d.seriesName === "経過時間");
  if (!elapsedDataset) {
    elapsedDataset = {
      label: "経過時間",
      seriesName: "経過時間",
